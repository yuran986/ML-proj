...
for lr in lrs:
    ...
    train_val(model=model, optimizer=optimizer, scheduler=scheduler, criterion=criterion, train_loader=train_loader, valid_loader=valid_loader, num_epochs=num_epochs, lr=lr, model_savingpath=model_savingpath, saving_path=saving_path, target='eval')

# 五折交叉验证
# kf = KFold(n_splits=5, shuffle=True, random_state=42)
# saving_path = 'result1.csv'
# lrs = [0.01]
# for lr in lrs:
