...
from dataset_ import load_dataset, load_dataset, CustomDataset
...
'''
train_encoder_mlp2.py: train PredictValueNetwork for task2
'''
...
model_savingpath = './models_network2'
...
for lr in lrs:
    ...
    model, optimizer, start_epoch, start_loss = load_checkpoint(model, optimizer, "/home/wangyaoyao/projs/ML/project/models_network2/checkpoints/checkpoint_0.001_50.pth")
