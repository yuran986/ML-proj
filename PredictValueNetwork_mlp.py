...
class NodeEncoder(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        # print(x)
        x_embedding = self.node_type_embedding(x[:, 0].long())
...
class PredictValueNetwork(nn.Module):
    """
    ...
    """
    def __init__(self, node_enc_outdim=3, gnn_hidden_dim = 32,num_gcn_layer = 2,
        ...
        super(PredictValueNetwork, self).__init__()
        ...
        self.layer1 = nn.Linear(self.aig_emb_dim, 1024)
        self.relu1 = nn.ReLU()
    ...
    def forward(self, batchData):
        # print(batchData.batch.shape)
        x = self.aig(batchData)
